...
const uri = `mongodb+srv://health_admin:7Wfkz5u8LT6il7zT@cluster0.7n5esqf.mongodb.net/?retryWrites=true&w=majority`;
...
// // const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.7n5esqf.mongodb.net/?retryWrites=true&w=majority`;
// // console.log(uri);
...
// // });
// app.get("/", (req, res) => {
//   res.send("welcome to doctors website");
// });
...
// const uri =
//   "mongodb+srv://homeservice:XIY8UkG9HASA8PvC@cluster0.kq3to.mongodb.net/?retryWrites=true&w=majority";
// const client = new MongoClient(uri, {
//   useNewUrlParser: true,
//   useUnifiedTopology: true,
//   serverApi: ServerApiVersion.v1,
